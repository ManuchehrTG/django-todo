...
from configs import app_config, django_config, telegram_bot_config, redis_config, database_config
...
CELERY_BROKER_URL = str(redis_config.DSN)
CELERY_RESULT_BACKEND = str(redis_config.DSN)
...
STATIC_ROOT = django_config.STATIC_ROOT
